...
def dfs(disciplina, grafo, status_do_curso, visitados):
    ...
    # Explora recursivamente as disciplinas com pré-requisitos
    for prereq in prereqs:
        recomendacoes.extend(dfs(prereq, grafo, status_do_curso, visitados))
...
def recomendar_matriculas(grafo, status_do_curso):
    ...
    for disciplina in grafo:
        if disciplina not in visitados:
            recomendacoes.extend(dfs(disciplina, grafo, status_do_curso, visitados))
